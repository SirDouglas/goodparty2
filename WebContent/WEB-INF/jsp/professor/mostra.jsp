...
<body>
<form id="professorForm" action="<c:url value="/professor/${professor.id}"/>" method="POST">
<fieldset>
...
<fmt:formatDate value="${professor.dataNascimento.time}" var="data"/>
<caelum:campoData id="dataNascimento" name="professor.dataNascimento" value="${data}"     /> <br />
<label for="obs"></label>
